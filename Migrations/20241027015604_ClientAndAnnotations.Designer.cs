...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20241027015604_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 26, 21, 56, 4, 28, DateTimeKind.Local).AddTicks(8592),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2024, 10, 26, 21, 56, 4, 28, DateTimeKind.Local).AddTicks(8645),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 26, 21, 56, 4, 28, DateTimeKind.Local).AddTicks(8648),
                            ServicesID = 5
                        });
                });
