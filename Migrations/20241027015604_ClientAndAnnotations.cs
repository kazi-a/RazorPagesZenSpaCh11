    ...
    public partial class ClientAndAnnotations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 10, 26, 21, 56, 4, 28, DateTimeKind.Local).AddTicks(8592), 1 },
                    { 2, 2, new DateTime(2024, 10, 26, 21, 56, 4, 28, DateTimeKind.Local).AddTicks(8645), 7 },
                    { 3, 1, new DateTime(2024, 10, 26, 21, 56, 4, 28, DateTimeKind.Local).AddTicks(8648), 5 }
                });
